create index denormalized1 on tweets_jsonb using gin((data->'extended_tweet'->'entities'->'hashtags'));
create index denormalized2 on tweets_jsonb using gin((data->'entities'->'hashtags'));
